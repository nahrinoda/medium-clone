...
export default function Home({ posts }: Props) {
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <Header />
      <div className="flex justify-between items-center bg-yellow-400 border-y border-y-black py-10 lg:py-0">
        ...
        {posts.map(post => (
          <Link key={post._id} href={`/post/${post.slug.current}`}>
            <div className="border rounded-lg group cursor-pointer overflow-hidden">
              <img className="h-60 w-full object-cover group-hover:scale-105 transition-transform ease-in-out" src={urlFor(post.mainImage).url()!} alt="post main image" />
